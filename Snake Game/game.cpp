...
public:
    ...
    {
        Image image = LoadImage("/home/abby/Documents/C++ Project | IT/Snake Game/Resources/food.png");
...
public:
    ...
    {
        InitAudioDevice();
        eatSound = LoadSound("/home/abby/Documents/C++ Project | IT/Snake Game/Resources/eat.mp3");
        wallSound = LoadSound("/home/abby/Documents/C++ Project | IT/Snake Game/Resources/wall.mp3");
    }
    ~Game()
    {
...
int main()
{
    InitWindow(2 * offset + cellSize * cellCount, 2 * offset + cellSize * cellCount, "Sanke Game");
    SetTargetFPS(60);
    ...
    while (WindowShouldClose() == false)
    {
        ...
        if (!running)
        {
            Font gameoverfont = LoadFont("/home/abby/Documents/C++ Project | IT/Snake Game/Resources/game_over.ttf");
            float fontSize = 80;
        ...
        if (paused)
        {
            Font pausedfont = LoadFont("/home/abby/Documents/C++ Project | IT/Snake Game/Resources/game_over.ttf");
            float fontSize = 80;
            DrawTextEx(
                pausedfont,
                "PAUSED",
